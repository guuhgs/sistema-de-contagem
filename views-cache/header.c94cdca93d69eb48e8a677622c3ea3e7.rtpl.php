...
<head>
  ...
  <title>Sistema de Contagem - Admin</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="/admin/atualizar-dados"><i class="fa fa-refresh"></i> <span>Atualizar Dados</span></a></li>
        <li class="treeview">
          <a href="#"><i class="fa fa-hashtag"></i> <span>Contagem</span>
